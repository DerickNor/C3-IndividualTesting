...
enum CanvasSize: String, CaseIterable, Hashable {
...
struct VideoProject: Identifiable, Hashable {
    ...
    init(id: UUID = UUID(), title: String, creationDate: Date = Date(), lastModifiedDate: Date = Date(), thumbnailData: Data? = nil, canvasSize: CanvasSize = .story) {
        self.id = id
        self.title = title
